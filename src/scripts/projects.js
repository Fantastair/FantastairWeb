const projects = [
    {
        ...
        hasRelease: true,
        extraLinks: [
            { label: "项目主站", url: "https://fantas.fantastair.cn" },
            { label: "在线文档", url: "https://fantas.fantastair.cn/docs/" },
            { label: "PyPI", url: "https://pypi.org/project/fantas/" },
        ],
    },
    {
...
const externalSvg = `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 13v6a2 2 0 01-2 2H6a2 2 0 01-2-2V9a2 2 0 012-2h6"/><polyline points="15 3 21 3 21 9"/><line x1="10" y1="14" x2="21" y2="3"/></svg>`;
...
projects.forEach((p) => {
    ...
    if (p.extraLinks) {
        p.extraLinks.forEach((el) => {
            const extLink = document.createElement("a");
            extLink.className = "project-link";
            extLink.href = el.url;
            extLink.target = "_blank";
            extLink.rel = "noopener noreferrer";
            extLink.innerHTML = `${externalSvg} ${el.label}`;
